...
class SFTTrainer(Trainer):
    ...
    Args:
        ...
        dataset_kwargs: (`Optional[Dict]`, *optional*):
            Dict of Optional kwargs to pass when creating packed or non-packed dataset
    """
    _tag_names = ["trl", "sft"]
    ...
    def __init__(
        ...
        # Pre-process the dataset only once per node. The remaining processes will use the cache.
