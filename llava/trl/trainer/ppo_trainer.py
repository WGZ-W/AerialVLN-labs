...
class PPOTrainer(BaseTrainer):
    ...
    Attributes:
        ...
        **dataset** (Union[`torch.utils.data.Dataset`, `dataset.Dataset`], *optional*) -- PyTorch dataset or Hugging
    ...
    def __init__(
        ...
        if dataset is not None and not (isinstance(dataset, torch.utils.data.Dataset) or isinstance(dataset, Dataset)):
            raise ValueError("dataset must be a torch.utils.data.Dataset or dataset.Dataset")
