    ...
    def __init__(self, image_resize_strategy: str, default_image_size: int = 224, grid_size: int = 16) -> None:
        ...
        self.dino_featurizer: VisionTransformer = timm.create_model(
            ...
            pretrained_cfg_overlay={
                'file': '/home/weiguanzhao/OpenFly2/vit_large_patch14_reg4_dinov2.lvd142m/pytorch_model.bin'}
        )
        ...
        self.siglip_featurizer: VisionTransformer = timm.create_model(
            ...
            pretrained_cfg_overlay={
                'file': '/home/weiguanzhao/OpenFly2/vit_so400m_patch14_siglip_224.webli/pytorch_model.bin'}
        )
