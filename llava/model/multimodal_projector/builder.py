...
from .base_projector import MultimodalProjector, MultimodalProjectorConfig, MambaProjector


# 根据配置构建或加载多模态投影器，负责将视觉特征投影到语言模型的嵌入空间。
...
def build_mb_projector(config: PretrainedConfig) -> torch.nn.Module:
    mb_projector = MambaProjector(config)
    return mb_projector
