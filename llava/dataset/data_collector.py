...
from llava.dataset.dataset import RLDSBatchTransform, RLDSDataset
import tensorflow as tf

from llava.dataset.data_utils import decode_and_resize, augment, chunk_act_obs, add_pad_mask_dict, subsample
...
def get_vla_dataset_and_collator(
    ...
    batch_transform = RLDSBatchTransform(
        ...
        # action_tokenizer, tokenizer, image_processor, predict_stop_token=predict_stop_token
        # action_tokenizer, tokenizer, image_transform, image_processor, predict_stop_token=predict_stop_token
    )
