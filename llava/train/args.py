...
class DataArguments:
    ...
    # 修改成我放置的位置
    data_path: str = "/mnt/sda/wgz/OpenFly-rlds"
    ...
    # output_dir: Optional[str] = field(default="/mnt/sda/wgz/navila_output")

    # OpenFly
    # Directory Paths
    data_root_dir: Path = Path(
        "/mnt/sda/wgz/OpenFly-rlds"
    )
    run_root_dir: Path = Path("/mnt/sda/wgz/navila")
    ...
    # shuffle_buffer_size: int = 150_00
