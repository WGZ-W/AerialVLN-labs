...
class Param:
    def __init__(self):
        ...
        # project_prefix = Path(str(os.getcwd())).parent.parent.parent.resolve()
        ...
        self.parser.add_argument('--deepspeed', action='store_true', help='Use DeepSpeed for distributed training')
        self.parser.add_argument('--deepspeed_config', type=str, default='ds_config.json', help='DeepSpeed config file')
